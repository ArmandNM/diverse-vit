...
import diverse_vit.datasets.scripts_mnist_cifar.lms_utils as au
import diverse_vit.datasets.scripts_mnist_cifar.synth_models
...
def get_mnist(fpath, flatten=False, binarize=False, normalize=True, y0={0,1,2,3,4}):
...
def get_mnist_dl(fpath, to_np=False, bs=128, pm=False, shuffle=False,
...
def get_cifar(fpath, use_cifar10=False, flatten_data=False, transform_type='none',
...
def get_cifar_dl(fpath, use_cifar10=False, bs=128, shuffle=True, transform_type='none',
...
def get_cifar_np(fpath, use_cifar10=False, flatten_data=False, transform_type='none', normalize=True, binarize=False, y0={0,1,2,3,4}, use_grayscale=False):
